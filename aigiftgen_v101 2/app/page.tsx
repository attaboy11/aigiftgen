  ...
  return (
    <main className="max-w-2xl mx-auto p-6">
      <header className="mt-12 mb-8 text-center">
        ...
        <p className="small mt-2">Tell AI Santa who you&apos;re shopping for. Get 3–5 witty, spot‑on gift ideas.</p>
      </header>
      ...
      <div className="card p-5">
        ...
        <div className="flex gap-2 mt-4">
          ...
          <a href="/clone" className="btn btn-ghost">Clone this site → earn too</a>
        </div>
      </div>
      ...
      <section className="mt-6">
        {ideas.map((idea, i)=>(
          <Idea key={i} idea={idea} affiliateTag={affiliateTag as string} />
        ))}
      </section>

      <footer className="mt-10 text-center small">
        Built by AI · <a className="link" href="https://aigiftgen.co.uk" target="_blank">aigiftgen.co.uk</a> · Not affiliated with Amazon.
      </footer>
    </main>
  );
}
